...
LIFECYCLE_DEFS_PATH = BASE_PATH / "lifecycle_phase_defs1.txt"
JOB_SERIES_DEFS_PATH = BASE_PATH / "job_series_defs1.txt"

# Gracefully support root directory placement as fallback
if not LIFECYCLE_DEFS_PATH.exists():
    LIFECYCLE_DEFS_PATH = Path("lifecycle_phase_defs1.txt")
if not JOB_SERIES_DEFS_PATH.exists():
    JOB_SERIES_DEFS_PATH = Path("job_series_defs1.txt")
